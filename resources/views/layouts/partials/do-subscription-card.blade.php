        ...
        <div class="d-flex">
            ...
            <div>
                ...
                <div class="subscription-details mb-4">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="mb-1"><strong>Plan:</strong> {{ auth()->user()->inactiveSubscription->plan->name }}</p>
                            <p class="mb-1"><strong>Amount Due:</strong> KES {{ number_format(auth()->user()->inactiveSubscription->plan->price,2) }}</p>
                        </div>
                    </div>
                </div>

                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="{{ route('subscription.pay',auth()->user()->inactiveSubscription->id) }}" class="btn btn-danger me-md-2">
